...
_SEXUAL_CONTEXT_PATTERNS = (
    re.compile(r"(?:おっぱい|ちんちん|おちんちん|性器|陰部).{0,24}(?:吸う|舐める|触る|揉む|性的|エッチ|快感)"),
    re.compile(r"(?:吸う|舐める|触る|揉む|性的|エッチ|快感).{0,24}(?:おっぱい|ちんちん|おちんちん|性器|陰部)"),
    re.compile(r"(?:裸|裸体|全裸).{0,24}(?:性的|エッチ|快感|触る|舐める|挿入)"),
    re.compile(r"(?:赤ちゃんプレイ|成人.*赤ちゃん|大人.*赤ちゃん).{0,24}(?:性的|エッチ|快感|行為)"),
)
